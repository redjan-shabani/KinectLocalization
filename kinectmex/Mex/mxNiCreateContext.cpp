...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) {
    ...
    if (nrhs > 1) {
         ...
         {
            address=( unsigned __int64)&g_Context;
         }
    }
    else {
    ...
    else
    {
        ...
        MXadress[1] = (unsigned __int64)&g_image;
    }
    ...
    else
    {
        ...
        MXadress[2] = (unsigned __int64)&g_DepthGenerator;
    }
    ...
    else
    {
        ...
        MXadress[3] = (unsigned __int64)&g_ir;
    }
    ...
    else
    {
        ...
        MXadress[4] = (unsigned __int64)&g_UserGenerator;
    }
